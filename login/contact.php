...
$db = getDbInstance();
$select = array('id', 'name', 'email_id', 'phone', 'response');
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">Contact Form Responses</h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="dcsvcontact.php" class="btn btn-success"><i class="glyphicon glyphicon-check"></i> Export as CSV</a>
            </div>
        </div>
    </div>
